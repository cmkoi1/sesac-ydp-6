...
// 함수 선언 방식
// #1. 명시적 함수 선언(= 함수 선언문)
// - 함수 이름과 매개변술ㄹ 명시하고 함수의 본문을 중괄호로 감싼다.
// - 스크립트 어디에서든 호출할 수 있다(호이스팅).
...
// return? (반환값)
// - 함수 내부(body, blockk) 코드의 "최종 결과 값"
// - 최종 결과값을 저장하고 보관하기 위한 키워드
// - return 키워드를 만나면 함수 실행 중단(return 이후 코드 작성은 의미가 없다고 판단)
...
// -> 이름을 지정할 수도 있음.
// - 이 경우 함수 이름은 블록 스코프 내부에서만 사용 가능하다.
// ex)
...
const HelloWord3 = function() {
    console.log("Hello, World! 3");
}
const HelloWord4 = function() {
    return "Hello, World! 4";
}

HelloWord3();
console.log(HelloWord4());
HelloWord3();
HelloWord3();
HelloWord3();
// 함수는 "여러 번" 호출이 가능하다.
...
// 매개변수는 어떤 데이터 타입이든 상관없다(이름을 정해주는 느낌).
...
// sayHello2(); // 참조 에러(ReferenceError)
const sayHello2 = () => {
    console.log("hello2~");
} 