...
mara.setAttribute("src", "../03-css/image/217797.png");

// getAtrribute(속성명) => 속성명 "얻기"
console.log(document.getElementById("mara").getAttribute("src"));

// # 참고 1, 속성 접근(.) 연산자로도 가능
console.log(document.getElementById('mara').id); // mara
console.log(document.getElementById('naver').href); // https://www.google.com

// # 참고 2, 연산자로 속성에 접근하고 "=" 할당 연산자로 속성 값 변경 가능.
document.getElementById('naver').href = '#' // #은 내부 앵커, 현재 페이지의 상단으로 스크롤
